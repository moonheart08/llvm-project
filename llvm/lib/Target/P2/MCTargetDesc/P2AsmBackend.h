//===-- P2AsmBackend.h - P2 Assembler Backend -----------------------------===//
//
...
public:
  P2AsmBackend(const MCSubtargetInfo &STI, const MCTargetOptions &OP)
...
#endif // LLVM_LIB_TARGET_P2_MCTARGETDESC_P2ASMBACKEND_H
